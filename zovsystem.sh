...
pre_install_docker_compose() {
    read -p "Nhập Node ID port 80 :" node_id80
    echo -e "Node_80 là : ${node_id80}"


    read -p "Nhập Node ID port 80 :" node_id443
    echo -e "Node_80 là : ${node_id443}"


    read -p "Nhập subdomain hoặc ip vps vpn80:" CertDomain80
    echo -e "CertDomain80 = ${CertDomain80}"  

    read -p "Nhập subdomain hoặc ip vps vpn443:" CertDomain443
