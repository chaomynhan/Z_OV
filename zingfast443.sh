...
# Để gỡ lỗi, hãy sử dụng iptables -v.
...
# Mặc định cho giới hạn tốc độ
#------------------------------------------------------------------------------
RLIMIT="-m limit --limit 3/s --limit-burst 8"

# Cổng không có đặc quyền.
#------------------------------------------------------------------------------
PHIGH="1024:65535"
PSSH="1000:1023"
...
# Giảm thiểu hành vi giả mạo/đầu độc ARP và các cuộc tấn công tương tự.
#------------------------------------------------------------------------------
...
# Kích hoạt bảo vệ giả mạo IP
for i in /proc/sys/net/ipv4/conf/*/rp_filter; do echo 1 > "$i"; done

# Bảo vệ chống lại các cuộc tấn công lũ SYN
echo 1 > /proc/sys/net/ipv4/tcp_syncookies

# Bỏ qua tất cả các yêu cầu echo ICMP đến
